...
m.push(()=>S),f.push((e,t)=>t===S)
new g(2,null)
function k({tag:e}){return e===v}function w(e){return e===v}let S=p
class _ extends d{static create(e=S){return new g(this.id,new _(e))}constructor(e=S){super(),this.revision=e}value(){return this.revision}dirty(){this.revision=++S}}function E(e){let t=[]
for(let s=0,i=e.length;s<i;s++){let i=e[s].tag
if(i===y)return y
i!==v&&t.push(i)}return O(t)}function C(e){let t=[],s=e.head()
for(;null!==s;){let i=s.tag
if(i===y)return y
i!==v&&t.push(i),s=e.nextNode(s)}return O(t)}function x(e){let t=[]
for(let s=0,i=e.length;s<i;s++){let i=e[s]
if(i===y)return y
i!==v&&t.push(i)}return O(t)}function O(e){switch(e.length){case 0:return v
case 1:return e[0]
case 2:return N.create(e[0],e[1])
default:return T.create(e)}}b(_)
class A extends d{constructor(){super(...arguments),this.lastChecked=null,this.lastValue=null}value(){let e=this.lastChecked,t=this.lastValue
return e!==S&&(this.lastChecked=S,this.lastValue=t=this.compute()),this.lastValue}invalidate(){this.lastChecked=null}}class N extends A{static create(e,t){return new g(this.id,new N(e,t))}constructor(e,t){super(),this.first=e,this.second=t}compute(){return Math.max(this.first.value(),this.second.value())}}b(N)
class T extends A{static create(e){return new g(this.id,new T(e))}constructor(e){super(),this.tags=e}compute(){let e=this.tags,t=-1
for(let s=0;s<e.length;s++){let i=e[s].value()
t=Math.max(i,t)}return t}}b(T)
class L extends A{static create(e){return new g(this.id,new L(e))}constructor(e){super(),this.tag=e,this.lastUpdated=p}compute(){return Math.max(this.lastUpdated,this.tag.value())}update(e){e!==this.tag&&(this.tag=e,this.lastUpdated=S,this.invalidate())}}b(L)
class D{constructor(){this.lastRevision=null,this.lastValue=null}value(){let e=this.tag,t=this.lastRevision,s=this.lastValue
return null!==t&&e.validate(t)||(s=this.lastValue=this.compute(),this.lastRevision=e.value()),s}invalidate(){this.lastRevision=null}}class B{constructor(e){this.lastValue=null,this.lastRevision=null,this.initialized=!1,this.tag=e.tag,this.reference=e}peek(){return this.initialized?this.lastValue:this.initialize()}revalidate(){if(!this.initialized)return this.initialize()
...
e.retained=!0,s.remove(e),s.insertBefore(e,t)}remove(e){this.list.remove(e),delete this.map[e.key]}nextNode(e){return this.list.nextNode(e)}head(){return this.list.head()}}var F;(function(e){e[e.Append=0]="Append",e[e.Prune=1]="Prune",e[e.Done=2]="Done"})(F||(F={}))
class j{constructor({target:e,artifacts:t}){this.target=e,this.artifacts=t,this.iterator=t.iterate(),this.current=t.head()}sync(){let e=F.Append
for(;;)switch(e){case F.Append:e=this.nextAppend()
break
case F.Prune:e=this.nextPrune()
break
case F.Done:return void this.nextDone()}}advanceToKey(e){let t=this.current,s=this.artifacts,i=t
...
s.insert(n.key,n.value,n.memo,i?i.key:null)}startPrune(){return this.current=this.artifacts.head(),F.Prune}nextPrune(){let e=this.artifacts,t=this.target,s=this.current
if(null===s)return F.Done
let i=s
return this.current=e.nextNode(i),i.shouldRemove()?(e.remove(i),t.delete(i.key)):i.reset(),F.Prune}nextDone(){this.target.done()}}function V(...e){let t=e[0],s=e[1],i=e[2]
return"string"==typeof t?function(t,s,i){return H(t,s,i,e)}:i?H(t,s,i,[]):void function(e,t){let s,i=Symbol(t)
$(e).trackedProperties[t]=!0,void 0!==e[t]&&(s=e[t])
Object.defineProperty(e,t,{configurable:!0,get(){return this[i]},set(e){$(this).dirtyableTagFor(t).inner.dirty(),this[i]=e,Y()}})}(t,s)}function H(e,t,s,i){let n=$(e)
return n.trackedProperties[t]=!0,n.trackedPropertyDependencies[t]=i||[],{enumerable:!0,configurable:!1,get:s.get,set:function(){$(this).dirtyableTagFor(t).inner.dirty(),s.set.apply(this,arguments),Y()}}}class z{constructor(e){this.tags=a(),this.computedPropertyTags=a(),this.trackedProperties=e?Object.create(e.trackedProperties):a(),this.trackedPropertyDependencies=e?Object.create(e.trackedPropertyDependencies):a()}tagFor(e){let t,s=this.tags[e]
...
return t&&function(e,t){return G.call(e,t)}(e,U)?t:e[U]=new z(t)}let G=Object.prototype.hasOwnProperty
let Y=function(){}
class W extends Error{constructor(e,t,s){super(s),this.target=e,this.key=t}static for(e,t){return new W(e,t,`The property '${t}' on ${e} was changed after being rendered. If you want to change a property used in a template after the component has rendered, mark the property as a tracked property with the @tracked decorator.`)}}function X(e,t,s=function(e,t){throw W.for(e,t)}){if("object"==typeof e&&e){return $(e).tagFor(t)}return v}class K{constructor(e){this.debugName=null,this.__args__=null,Object.assign(this,e)}get element(){let e=this.bounds
...
for(let i=t;i>0;i--){s[i-1]=e.stack.pop()}e.stack.push(new class extends D{constructor(e){super(),this.parts=e,this.tag=E(e)}compute(){let e=new Array
...
const ve=be(ge.Get),ye=be(ge.MaybeLocal)
var ke,we;(we=ke||(ke={}))[we.OpenComponentElement=0]="OpenComponentElement",we[we.DidCreateElement=1]="DidCreateElement",we[we.SetComponentAttrs=2]="SetComponentAttrs",we[we.DidRenderLayout=3]="DidRenderLayout",we[we.Debugger=4]="Debugger"
var Se=ge
const _e="&attrs"
...
n(e,t)}}let Ce,xe
function Oe(e,t,s){let i=e[1],n=e[2],r=e[3]
s.expr(n),r?s.dynamicAttr(i,r,t):s.dynamicAttr(i,null,t)}class Ae{constructor(){var e=function(e=new Ne,t=new Te){return e.add("if",(e,t,s,i,n)=>{if(!e||1!==e.length)throw new Error("SYNTAX ERROR: #if requires a single argument")
...
this.blocks=t,this.inlines=s}}class Ne{constructor(){this.names=a(),this.funcs=[]}add(e,t){this.funcs.push(t),this.names[e]=this.funcs.length-1}addMissing(e){this.missing=e}compile(e,t,s,i,n,r){let a=this.names[e]
...
if(r[0]===Se.Helper)s=r[1],i=r[2],n=r[3]
else{if(r[0]!==Se.Unknown)return["expr",r]
...
class De{constructor(e,t,s,i){this.statements=e,this.containingLayout=t,this.options=s,this.symbolTable=i,this.compiled=null,this.statementCompiler=function(){if(Ce)return Ce
const e=Ce=new Ee
e.add(Se.Text,(e,t)=>{t.text(e[1])}),e.add(Se.Comment,(e,t)=>{t.comment(e[1])}),e.add(Se.CloseElement,(e,t)=>{t.closeElement()}),e.add(Se.FlushElement,(e,t)=>{t.flushElement()}),e.add(Se.Modifier,(e,t)=>{let s=t.resolver,i=t.referrer,n=e[1],r=e[2],a=e[3],l=s.lookupModifier(n,i)
if(!l)throw new Error(`Compile Error ${n} is not a modifier: Helpers may not be used in the element form.`)
t.modifier(l,r,a)}),e.add(Se.StaticAttr,(e,t)=>{let s=e[1],i=e[2],n=e[3]
t.staticAttr(s,n,i)}),e.add(Se.DynamicAttr,(e,t)=>{Oe(e,!1,t)}),e.add(Se.TrustingAttr,(e,t)=>{Oe(e,!0,t)}),e.add(Se.OpenElement,(e,t)=>{t.openPrimitiveElement(e[1])}),e.add(Se.OpenSplattedElement,(e,t)=>{t.setComponentAttrs(!0),t.putComponentOperations(),t.openPrimitiveElement(e[1])}),e.add(Se.Component,(e,t)=>{let s=e[1],i=e[2],n=e[3],r=e[4],a=t.resolver,l=t.referrer,o=a.lookupComponentDefinition(s,l)
if(null===o)throw new Error(`Compile Error: Cannot find component ${s}`)
{let e=a.getCapabilities(o),s=[[Se.ClientSideStatement,ke.SetComponentAttrs,!0],...i,[Se.ClientSideStatement,ke.SetComponentAttrs,!1]],l=t.inlineBlock({statements:s,parameters:c}),h=t.template(r)
if(!1===e.dynamicLayout){let s=a.getLayout(o)
t.pushComponentDefinition(o),t.invokeStaticComponent(e,s,l,null,n,!1,h&&h)}else t.pushComponentDefinition(o),t.invokeComponent(l,null,n,!1,h&&h)}}),e.add(Se.Partial,(e,t)=>{let s=e[1],i=e[2],n=t.referrer
t.startLabels(),t.pushFrame(),t.returnTo("END"),t.expr(s),t.dup(),t.enter(2),t.jumpUnless("ELSE"),t.invokePartial(n,t.evalSymbols(),i),t.popScope(),t.popFrame(),t.label("ELSE"),t.exit(),t.return(),t.label("END"),t.popFrame(),t.stopLabels()}),e.add(Se.Yield,(e,t)=>{let s=e[1],i=e[2]
t.yield(s,i)}),e.add(Se.AttrSplat,(e,t)=>{let s=e[1]
t.yield(s,[]),t.didCreateElement(le.s0),t.setComponentAttrs(!1)}),e.add(Se.Debugger,(e,t)=>{let s=e[1]
t.debugger(t.evalSymbols(),s)}),e.add(Se.ClientSideStatement,(e,s)=>{t.compile(e,s)}),e.add(Se.Append,(e,t)=>{let s=e[1],i=e[2]
if(!0===(t.macros.inlines.compile(e,t)||s))return
let n=ve(s),r=ye(s)
i?t.guardedAppend(s,!0):n||r?t.guardedAppend(s,!1):(t.expr(s),t.primitive(!1),t.load(le.t0),t.dynamicContent())}),e.add(Se.Block,(e,t)=>{let s=e[1],i=e[2],n=e[3],r=e[4],a=e[5],l=t.template(r),o=t.template(a),h=l&&l,u=o&&o
t.macros.blocks.compile(s,i,n,h,u,t)})
const t=new Ee(1)
return t.add(ke.OpenComponentElement,(e,t)=>{t.putComponentOperations(),t.openPrimitiveElement(e[2])}),t.add(ke.DidCreateElement,(e,t)=>{t.didCreateElement(le.s0)}),t.add(ke.SetComponentAttrs,(e,t)=>{t.setComponentAttrs(e[2])}),t.add(ke.Debugger,()=>{}),t.add(ke.DidRenderLayout,(e,t)=>{t.didRenderLayout(le.s0)}),e}()}static topLevel(e,t){return new De(e.statements,{block:e,referrer:t.referrer},t,{referrer:t.referrer,hasEval:e.hasEval,symbols:e.symbols})}compile(e){let t=this.compiled
if(null!==t)return t
this.compiled=Le
...
return this.compiled=c}}class Be{constructor(e){this.builder=e}static(e,t){let s=t[0],i=t[1],n=t[2],r=t[3],a=this.builder,l=a.resolver
...
return new De(s,this.containingLayout,n,i)}evalSymbols(){let e=this.containingLayout.block
...
this.push(40,t)}else this.primitive(null)}pushBlockScope(){this.push(39)}pushYieldableBlock(e){this.pushSymbolTable(e&&e.symbolTable),this.pushBlockScope(),this.pushBlock(e)}template(e){return e?this.inlineBlock(e):null}}class Fe extends Pe{pushBlock(e){e?this.pushOther(e):this.primitive(null)}resolveBlock(){this.push(38)}pushLayout(e){e?this.pushOther(e):this.primitive(null)}resolveLayout(){this.push(38)}invokeStatic(e){this.pushOther(e),this.push(38),this.pushMachine(41)}pushOther(e){this.push(10,this.other(e))}other(e){return this.constants.other(e)}}class je{constructor(){this.base=0,this.length=0,this.stack=null,this._tag=null,this._references=null}setup(e,t,s){this.stack=e,this.base=t,this.length=s,0===s?(this._tag=v,this._references=c):(this._tag=null,this._references=null)}get tag(){let e=this._tag
...
e=this._references=t.sliceArray(s,s+i)}return e}}class Ve{constructor(e,t,s=t.length){this.tag=e,this.references=t,this.length=s}static empty(){return new Ve(v,c,0)}at(e){return this.references[e]}value(){return this.references.map(this.valueOf)}get(e){let t=this.references,s=this.length
if("length"===e)return oe.create(s)
{let i=parseInt(e,10)
return i<0||i>=s?ce:t[i]}}valueOf(e){return e.value()}}class He{constructor(){this.base=0,this.length=0,this._references=null,this._names=c,this._atNames=c}setup(e,t,s,i,n){this.stack=e,this.base=t,this.length=s,0===s?(this._references=c,this._names=c,this._atNames=c):(this._references=null,n?(this._names=i,this._atNames=null):(this._names=null,this._atNames=i))}get tag(){return E(this.references)}get names(){let e=this._names
...
return-1===n?ce:i.get(n,s)}capture(){return new ze(this.tag,this.names,this.references)}merge(e){let t=e.length
...
e=this._references=i.sliceArray(t,t+s)}return e}toSyntheticName(e){return e.slice(1)}toAtName(e){return`@${e}`}}class ze{constructor(e,t,s){this.tag=e,this.names=t,this.references=s,this.length=t.length,this._map=null}get map(){let e=this._map
...
for(let i=0;i<e.length;i++){s[e[i]]=t[i].value()}return s}}class Ue{constructor(){this.internalValues=null,this.internalTag=null,this.names=c,this.length=0,this.base=0}setup(e,t,s,i){this.stack=e,this.names=i,this.base=t,this.length=s,0===s?(this.internalTag=v,this.internalValues=c):(this.internalTag=null,this.internalValues=null)}get values(){let e=this.internalValues
if(!e){let t=this.base,s=this.length,i=this.stack
...
return-1===t?null:[this.values[3*t+2],this.values[3*t+1],this.values[3*t]]}}const Ge=new ze(v,c,c),Ye=new Ve(v,c),We={tag:v,length:0,positional:Ye,named:Ge},Xe="CURRIED COMPONENT DEFINITION [id=6f00feb9-a0ef-4547-99ea-ac328f80acea]"
function Ke(e){return!(!e||!e[Xe])}class qe{constructor(e,t){this.inner=e,this.args=t,this[Xe]=!0}unwrap(e){e.realloc(this.offset)
let t=this
for(;;){var s=t
...
let u=s.getTag(o)
w(u)||e.updateWith(new class extends ae{constructor(e,t,s){super(),this.tag=e,this.manager=t,this.modifier=s,this.type="update-modifier",this.lastUpdated=e.value()}evaluate(e){let t=this.manager,s=this.modifier,i=this.tag,n=this.lastUpdated
...
n.state=h
let u=a.getTag(h)
w(u)||e.updateWith(new class extends ae{constructor(e,t,s,i){super(),this.tag=e,this.component=t,this.manager=s,this.dynamicScope=i,this.type="update-component"}evaluate(e){let t=this.component,s=this.manager,i=this.dynamicScope
...
i.didRenderLayout(n,r),e.env.didCreate(n,i),e.updateWith(new class extends ae{constructor(e,t,s){super(),this.manager=e,this.component=t,this.bounds=s,this.type="did-update-layout",this.tag=v}evaluate(e){let t=this.manager,s=this.component,i=this.bounds
...
class ft{constructor(e,t){this.element=e,this.nextSibling=t}}class gt{constructor(e,t,s){this.parentNode=e,this.first=t,this.last=s}parentElement(){return this.parentNode}firstNode(){return this.first}lastNode(){return this.last}}class bt{constructor(e,t){this.parentNode=e,this.node=t}parentElement(){return this.parentNode}firstNode(){return this.node}lastNode(){return this.node}}function vt(e,t){return new bt(e,t)}function yt(e,t){let s=e.parentElement(),i=e.firstNode(),n=e.lastNode(),r=i
...
n=e}return null}const wt="http://www.w3.org/2000/svg"
function St(e,t,s){if(!e)return t
if(!function(e,t){let s=e.createElementNS(t,"svg")
try{s.insertAdjacentHTML("beforeend","<circle></circle>")}catch(e){}finally{return 1!==s.childNodes.length||s.firstChild.namespaceURI!==wt}}(e,s))return t
...
class At{constructor(e){this.document=e,this.setupUselessElement()}setupUselessElement(){this.uselessElement=this.document.createElement("div")}createElement(e,t){let s,i
...
return new gt(r,o,n)}(this.uselessElement,e,t,s)}createTextNode(e){return this.document.createTextNode(e)}createComment(e){return this.document.createComment(e)}}var Nt;(function(e){class t extends At{createElementNS(e,t){return this.document.createElementNS(e,t)}setAttribute(e,t,s,i=null){i?e.setAttributeNS(i,t,s):e.setAttribute(t,s)}}e.TreeConstruction=t
let s=t
s=_t(Ot,s),s=St(Ot,s,Et),e.DOMTreeConstruction=s})(Nt||(Nt={}))
let Tt=class extends At{constructor(e){super(e),this.document=e,this.namespace=null}setAttribute(e,t,s){e.setAttribute(t,s)}removeAttribute(e,t){e.removeAttribute(t)}insertAfter(e,t,s){this.insertBefore(e,t,s.nextSibling)}}
Tt=_t(Ot,Tt)
var Lt=Tt=St(Ot,Tt,Et)
const Dt=Nt.DOMTreeConstruction,Bt=["javascript:","vbscript:"],Rt=["A","BODY","LINK","IMG","IFRAME","BASE","FORM"],Mt=["EMBED"],It=["href","src","background","action"],Pt=["src"]
function Ft(e,t){return-1!==e.indexOf(t)}function jt(e,t){return(null===e||Ft(Rt,e))&&Ft(It,t)}function Vt(e,t){return null!==e&&(Ft(Mt,e)&&Ft(Pt,t))}function Ht(e,t){return jt(e,t)||Vt(e,t)}function zt(e,t,s,i){let n=null
if(null===i||void 0===i)return i
if(at(i))return i.toHTML()
n=t?t.tagName.toUpperCase():null
let r=nt(i)
if(jt(n,s)){let t=e.protocolForURL(r)
if(Ft(Bt,t))return`unsafe:${r}`}return Vt(n,s)?`unsafe:${r}`:r}function Ut(e,t){let s,i
...
return"attr"===n?Yt(s,r):function(e,t){if(Ht(e,t))return qt
if(function(e,t){return("INPUT"===e||"TEXTAREA"===e)&&"value"===t}(e,t))return Zt
if(function(e,t){return"OPTION"===e&&"selected"===t}(e,t))return Qt
return Kt}(s,r)}function Yt(e,t){return Ht(e,t)?Jt:Xt}class Wt{constructor(e){this.attribute=e}}class Xt extends Wt{set(e,t,s){let i=es(t)
...
null===s?n.removeAttribute(r):n.setAttribute(r,s)}}class Kt extends Wt{set(e,t,s){if(null!==t&&void 0!==t){let s=this.attribute.name
...
let n=zt(s,i.element,i.name,t)
super.set(e,n,s)}update(e,t){var s=this.attribute
let i=zt(t,s.element,s.name,e)
super.update(i,t)}}class Jt extends Xt{set(e,t,s){var i=this.attribute
let n=zt(s,i.element,i.name,t)
super.set(e,n,s)}update(e,t){var s=this.attribute
let i=zt(t,s.element,s.name,e)
...
return this.dom.insertBefore(this.element,e,this.nextSibling),s}return vt(this.element,this.__appendComment(""))}__appendHTML(e){return this.dom.insertHTMLBefore(this.element,this.nextSibling,e)}appendTrustingDynamicContent(e){let t=new as(this.__appendTrustingDynamicContent(e))
...
return new os(vt(this.element,t),t,!0)}return this.trustedContent(String(e))}appendCautiousDynamicContent(e){let t=new as(this.__appendCautiousDynamicContent(e))
...
return new os(vt(this.element,t),t,!1)}if(at(e)){let t=e.toHTML(),s=this.__appendHTML(t)
...
case 4:return-(e>>3)
default:throw new Error("unreachable")}}(this.vec[e])}reset(){this.vec.length=0}len(){return this.vec.length}}const ys=2147483648,ks=2147483647
class ws{constructor(e=new vs,t=[]){this.inner=e,this.js=t}slice(e,t){let s
return s="number"==typeof e&&"number"==typeof t?this.inner.slice(e,t):"number"==typeof e&&void 0===t?this.inner.sliceFrom(e):this.inner.clone(),new ws(s,this.js.slice(e,t))}sliceInner(e,t){let s=[]
...
this.js.push(t),this.inner.writeRaw(e,s|ys)}}writeSmi(e,t){this.inner.writeSmi(e,t)}writeImmediate(e,t){this.inner.writeRaw(e,t)}get(t){let s=this.inner.getRaw(t)
return s&ys?this.js[s&ks]:function(t){switch(t){case 3:return!1
case 11:return!0
case 19:return null
case 27:return
default:return function(t){switch(7&t){case 0:return t>>3
case 4:return-(t>>3)
default:throw e()}}(t)}}(s)}getSmi(e){return this.inner.getSmi(e)}reset(){this.inner.reset()}get length(){return this.inner.len()}}class Ss{constructor(e,t,s){this.stack=e,this.fp=t,this.sp=s}static empty(){return new this(new ws,0,-1)}static restore(e){let t=new ws
...
null!==e?e.evaluate(this):this.frameStack.pop()}}get frame(){return this.frameStack.current}goto(e){this.frame.goto(e)}try(e,t){this.frameStack.push(new Ns(e,t))}throw(){this.frame.handleException(),this.frameStack.pop()}}class Cs extends ae{constructor(e,t,s,i){super(),this.start=e,this.state=t,this.type="block",this.next=null,this.prev=null,this.children=i,this.bounds=s}parentElement(){return this.bounds.parentElement()}firstNode(){return this.bounds.firstNode()}lastNode(){return this.bounds.lastNode()}evaluate(e){e.try(this.children,null)}destroy(){this.bounds.destroy()}didDestroy(){this.state.env.didDestroy(this.bounds)}}class xs extends Cs{constructor(e,t,s,i){super(e,t,s,i),this.type="try",this.tag=this._tag=L.create(v)}didInitializeChildren(){this._tag.inner.update(C(this.children))}evaluate(e){e.try(this.children,this)}handleException(){let e=this.state,t=this.bounds,s=this.children,i=this.start,n=this.prev,r=this.next
s.clear()
let a=ds.resume(e.env,t,t.reset(e.env)),l=Ls.resume(e,a),o=new h
l.execute(i,t=>{t.stack=Ss.restore(e.stack),t.updatingOpcodeStack.push(o),t.updateWith(this),t.updatingOpcodeStack.push(s)}),this.prev=n,this.next=r}}class Os{constructor(e,t){this.opcode=e,this.marker=t,this.didInsert=!1,this.didDelete=!1,this.map=e.map,this.updating=e.children}insert(e,t,s,i){let n=this.map,r=this.opcode,a=this.updating,l=null,o=null
...
yt(a,i?l.firstNode():this.marker),r.remove(a),r.insertBefore(a,l)}delete(e){let t=this.map,s=t[e]
s.didDestroy(),kt(s),this.updating.remove(s),delete t[e],this.didDelete=!0}done(){this.opcode.didInitializeChildren(this.didInsert||this.didDelete)}}class As extends Cs{constructor(e,t,s,i,n){super(e,t,s,i),this.type="list-block",this.map=a(),this.lastIterated=p,this.artifacts=n
let r=this._tag=L.create(v)
...
return Ls.resume(s,i)}}class Ns{constructor(e,t){this.ops=e,this.exceptionHandler=t,this.current=e.head()}goto(e){this.current=e}nextStatement(){let e=this.current,t=this.ops
...
new Es(t,s,{alwaysRevalidate:e}).execute(i,this)}parentElement(){return this.bounds.parentElement()}firstNode(){return this.bounds.firstNode()}lastNode(){return this.bounds.lastNode()}handleException(){throw"this should never happen"}destroy(){this.bounds.destroy(),kt(this.bounds)}}class Ls{constructor(e,t,s,i,n){this.program=e,this.env=t,this.elementStack=n,this.dynamicScopeStack=new l,this.scopeStack=new l,this.updatingOpcodeStack=new l,this.cacheGroups=new l,this.listBlockStack=new l,this.s0=null,this.s1=null,this.t0=null,this.t1=null,this.v0=null,this.env=t,this.heap=e.heap,this.constants=e.constants,this.elementStack=n,this.scopeStack.push(s),this.dynamicScopeStack.push(i),this.inner=new ns(Ss.empty(),this.heap,e,{debugBefore:e=>ne.debugBefore(this,e,e.type),debugAfter:(e,t)=>{ne.debugAfter(this,e,e.type,t)}})}get stack(){return this.inner.stack}set stack(e){this.inner.stack=e}set currentOpSize(e){this.inner.currentOpSize=e}get currentOpSize(){return this.inner.currentOpSize}get pc(){return this.inner.pc}set pc(e){this.inner.pc=e}get ra(){return this.inner.ra}set ra(e){this.inner.ra=e}get fp(){return this.stack.fp}set fp(e){this.stack.fp=e}get sp(){return this.stack.sp}set sp(e){this.stack.sp=e}fetch(e){this.stack.push(this[le[e]])}load(e){this[le[e]]=this.stack.pop()}fetchValue(e){return this[le[e]]}loadValue(e,t){this[le[e]]=t}pushFrame(){this.inner.pushFrame()}popFrame(){this.inner.popFrame()}goto(e){this.inner.goto(e)}call(e){this.inner.call(e)}returnTo(e){this.inner.returnTo(e)}return(){this.inner.return()}static initial(e,t,s,i,n,r,a){let l=e.heap.scopesizeof(a),o=ts.root(s,l),u=new Ls(e,t,o,n,r)
...
return new xs(this.heap.gethandle(this.pc),i,n,new h)}enterItem(e,t){this.listBlock().map[e]=t,this.didEnter(t)}enterList(e){let t=new h,s=this.capture(0),i=this.elements().pushBlockList(t),n=this.stack.peek().artifacts,r=this.pc+e-this.currentOpSize,a=this.heap.gethandle(r),l=new As(a,s,i,t,n)
...
t.set(i,this.stack.pop())}}}class Ds{constructor(e){this.vm=e}next(){return this.vm.next()}}let Bs=0
class Rs{constructor(e,t){this.options=e,this.parsedLayout=t,this.layout=null,this.partial=null
let s=t.block
this.symbols=s.symbols,this.hasEval=s.hasEval,this.statements=s.statements,this.referrer=t.referrer,this.id=t.id||`client-${Bs++}`}renderLayout(e){let t=e.env,s=e.self,i=e.dynamicScope
var n=e.args
let r=void 0===n?We:n,a=e.builder,l=this.asLayout().compile(),o=Ls.initial(this.options.program,t,s,r,i,a,l)
return new Ds(o)}asLayout(){return this.layout?this.layout:this.layout=Ms(this.parsedLayout,this.options,!1)}asPartial(){return this.partial?this.partial:this.partial=Ms(this.parsedLayout,this.options,!0)}}function Ms(e,t,s){let n=e.block,r=e.referrer,a=n.hasEval,l=n.symbols,o=i({},t,{asPartial:s,referrer:r})
return new De(n.statements,e,o,{referrer:r,hasEval:a,symbols:l})}class Is{get(e){return js.create(this,e)}}class Ps extends Is{constructor(){super(...arguments),this._lastRevision=null,this._lastValue=null}value(){let e=this.tag,t=this._lastRevision,s=this._lastValue
return t&&e.validate(t)||(s=this._lastValue=this.compute(),this._lastRevision=e.value()),s}}class Fs extends M{constructor(){super(...arguments),this.children=a()}get(e){let t=this.children[e]
return t||(t=this.children[e]=new Vs(this.inner,e)),t}}class js extends Ps{static create(e,t){return k(e)?new Vs(e.value(),t):new Hs(e,t)}get(e){return new Hs(this,e)}}class Vs extends js{constructor(e,t){super(),this._parentValue=e,this._propertyKey=t,this.tag=X(e,t)}compute(){return this._parentValue[this._propertyKey]}}class Hs extends js{constructor(e,t){super()
let s=e.tag,i=L.create(v)
...
return t.inner.update(X(i,s)),"string"==typeof i&&"length"===s?i.length:"object"==typeof i&&i?i[s]:void 0}}class zs extends Is{constructor(e){super(),this.tag=_.create(),this._value=e}value(){return this._value}update(e){e!==this._value&&(this.tag.inner.dirty(),this._value=e)}}class Us{constructor(e,t,s){let i=e.ComponentClass,n=e.name
this.args=t
let r={debugName:n,args:this.namedArgsSnapshot()}
se(r,s),i&&(this.component=i.create(r))}get tag(){return this.args.tag}namedArgsSnapshot(){return Object.freeze(this.args.named.value())}}const $s=new Fs(null)
...
return new Us(t,s.capture(),e)}}getSelf(e){return e?new Fs(e.component):$s}didCreateElement(e,t){}didRenderLayout(e,t){e&&(e.component.bounds=new ie(t))}didCreate(e){e&&e.component.didInsertElement()}getTag(e){return e?e.tag:v}update(e,t){e&&(e.component.args=e.namedArgsSnapshot())}didUpdateLayout(){}didUpdate(e){e&&e.component.didUpdate()}getDestructor(e){return e?e.component:Ys}}const Ys={destroy(){}}
function Ws(e,t,s){function i(){return Reflect.construct(HTMLElement,[],i)}i.prototype=Object.create(HTMLElement.prototype,{constructor:{value:i},connectedCallback:{value:function(){let t=document.createElement("span"),i=this.parentNode
...
t.setAttribute(e,r)}}(this,e)})}}}),window.customElements.define(t,i)}class Xs{constructor(e,t){this._registry=e,this._resolver=t}register(e,t,s){let i=this._toAbsoluteSpecifier(e)
...
return this._registry.registeredInjections(t)}_toAbsoluteSpecifier(e,t){return this._resolver.identify(e,t)}_toAbsoluteOrTypeSpecifier(e){return function(e){return-1===e.indexOf(":")}(e)?e:this._toAbsoluteSpecifier(e)}}class Ks{constructor(e=null){this.bucket=e?i({},e):{}}get(e){return this.bucket[e]}set(e,t){return this.bucket[e]=t}child(){return new Ks(this.bucket)}}class qs{constructor(e,t){this.position=0,this.array=e,this.keyFor=t}isEmpty(){return 0===this.array.length}next(){let e=this.position,t=this.array,s=this.keyFor
if(e>=t.length)return null
let i=t[e],n=s(i,e),r=e
return this.position++,{key:n,value:i,memo:r}}}class Js{constructor(e,t,s){this.position=0,this.keys=e,this.values=t,this.keyFor=s}isEmpty(){return 0===this.keys.length}next(){let e=this.position,t=this.keys,s=this.values,i=this.keyFor
if(e>=t.length)return null
let n=s[e],r=t[e],a=i(n,r)
return this.position++,{key:a,value:n,memo:r}}}const Zs=new class{isEmpty(){return!0}next(){throw new Error("Cannot call next() on an empty iterator")}}
class Qs{constructor(e,t){this.tag=e.tag,this.ref=e,this.keyFor=t}iterate(){let e=this.ref,t=this.keyFor,s=e.value()
if(Array.isArray(s))return s.length>0?new qs(s,t):Zs
if(void 0===s||null===s)return Zs
if(void 0!==s.forEach){let e=[]
return s.forEach(function(t){e.push(t)}),e.length>0?new qs(e,t):Zs}if("object"==typeof s){let e=Object.keys(s)
return e.length>0?new Js(e,e.map(e=>s[e]),t):Zs}throw new Error(`Don't know how to {{#each ${s}}}`)}valueReferenceFor(e){return new zs(e.value)}updateValueReference(e,t){e.update(t.value)}memoReferenceFor(e){return new zs(e.memo)}updateMemoReference(e,t){e.update(t.memo)}}class ei extends is{static create(e={}){return e.document=e.document||self.document,e.appendOperations=e.appendOperations||new Dt(e.document),new ei(e)}constructor(e){super({appendOperations:e.appendOperations,updateOperations:new Lt(e.document||document)}),se(this,te(e)),this.uselessAnchor=e.document.createElement("a")}protocolForURL(e){return this.uselessAnchor.href=e,this.uselessAnchor.protocol}iterableFor(e,t){let s
if(!t)throw new Error("Must specify a key for #each")
switch(t){case"@index":s=((e,t)=>String(t))
break
case"@primitive":s=(e=>String(e))
break
default:s=(e=>e[t])}return new Qs(e,s)}}const ti="object"==typeof document?document:null
class si{constructor(e){this._roots=[],this._rootsIndex=0,this._initializers=[],this._initialized=!1,this._rendering=!1,this._rendered=!1,this._scheduled=!1,this._notifiers=[],this.rootName=e.rootName,this.resolver=e.resolver,t(e.loader,"Must provide a Loader for preparing templates and other metadata required for a Glimmer Application."),t(e.renderer,"Must provide a Renderer to render the templates produced by the Loader."),t(e.builder,"Must provide a Builder that is responsible to building DOM."),this.document=e.document||ti,this.loader=e.loader,this.renderer=e.renderer,this.builder=e.builder}renderComponent(e,t,s=null){let i=this._roots,n=this._self
...
e.register(`environment:/${this.rootName}/main/main`,ei),e.registerOption("helper","instantiate",!1),e.registerOption("template","instantiate",!1),e.register(`document:/${this.rootName}/main/main`,this.document),e.registerOption("document","instantiate",!1),e.registerInjection("environment","document",`document:/${this.rootName}/main/main`),e.registerInjection("component-manager","env",`environment:/${this.rootName}/main/main`)
...
return se(t,this),t})}async _render(){let e=this.env,t=this._self=new zs({roots:this._roots}),s=new Ks,i=this.builder.getBuilder(e),n=await this.loader.getTemplateIterator(this,e,i,s,t)
...
this._notifiers=[],t.forEach(t=>t[1](e))}identify(e,t){return this.resolver.identify(e,t)}factoryFor(e,t){return this._container.factoryFor(this.identify(e,t))}lookup(e,t){return this._container.lookup(this.identify(e,t))}}class ii{constructor(){this.byName=a(),this.byHandle=a()}hasName(e){return e in this.byName}getHandle(e){return this.byName[e]}hasHandle(e){return e in this.byHandle}getByHandle(e){return this.byHandle[e]}register(e,t,s){this.byHandle[e]=s,this.byName[t]=e}}class ni{constructor(e,t){this.helper=e,this.tag=t.tag,this.args=t.capture()}value(){let e=this.helper,t=this.args
return e(t.positional.value(),t.named.value())}get(){return new Fs(this)}}class ri{constructor(e){this.owner=e,this.handleLookup=[],this.cache={component:new ii,template:new ii,compiledTemplate:new ii,helper:new ii,manager:new ii,modifier:new ii}}setCompileOptions(e){this.templateOptions=e}lookup(e,t,s){return this.cache[e].hasName(t)?this.cache[e].getHandle(t):null}register(e,t,s){let i=this.cache[e],n=this.handleLookup.length
...
return this.resolve(s)}registerHelper(e,t){return this.register("helper",e,(e,s)=>new ni(t,s))}registerInternalHelper(e,t){this.register("helper",e,t)}registerComponent(e,t,s,i){let n=this.registerTemplate(t,i),r=this.managerFor(n.meta.managerId),a=new J(e,r,s,n.handle)
...
return r}}const ai={},li=0,oi=Object.freeze([])
class hi{constructor(){this.strings=[],this.arrays=[oi],this.tables=[],this.handles=[],this.resolved=[],this.floats=[],this.negatives=[]}float(e){let t=this.floats.indexOf(e)
...
return this.array(t)}array(e){if(0===e.length)return li
let t=this.arrays.indexOf(e)
return t>-1?t:this.arrays.push(e)-1}handle(e){let t=this.handles.indexOf(e)
return t>-1?t:(this.resolved.push(ai),this.handles.push(e)-1)}serializable(e){let t=JSON.stringify(e),s=this.strings.indexOf(t)
return s>-1?s:this.strings.push(t)-1}toPool(){return{strings:this.strings,arrays:this.arrays,handles:this.handles,floats:this.floats,negatives:this.negatives}}}class ui extends hi{constructor(e,t){super(),this.resolver=e,t&&(this.strings=t.strings,this.arrays=t.arrays,this.handles=t.handles,this.floats=t.floats,this.negatives=t.negatives,this.resolved=this.handles.map(()=>ai))}getFloat(e){return this.floats[e]}getNegative(e){return this.negatives[e]}getString(e){return this.strings[e]}getStringArray(e){let t=this.getArray(e),s=new Array(t.length)
...
if(t===ai){let s=this.handles[e]
t=this.resolved[e]=this.resolver.resolve(s)}return t}getSerializable(e){return JSON.parse(this.strings[e])}}class ci extends ui{constructor(){super(...arguments),this.others=[],this.serializables=[]}serializable(e){let t=this.serializables.indexOf(e)
return t>-1?t:this.serializables.push(e)-1}getSerializable(e){return this.serializables[e]}getOther(e){return this.others[e-1]}other(e){return this.others.push(e)}}class pi{constructor(e){this.heap=e,this.offset=0}get size(){return 1+((768&this.heap.getbyaddr(this.offset))>>8)}get isMachine(){return 1024&this.heap.getbyaddr(this.offset)}get type(){return 255&this.heap.getbyaddr(this.offset)}get op1(){return this.heap.getbyaddr(this.offset+1)}get op2(){return this.heap.getbyaddr(this.offset+2)}get op3(){return this.heap.getbyaddr(this.offset+3)}}function di(e,t,s){return e|t<<16|s<<30}function mi(e,t){return e|t<<30}class fi{constructor(e){if(this.placeholders=[],this.offset=0,this.handle=0,e){let t=e.buffer,s=e.table,i=e.handle
...
let e=this.handle
return this.handle+=2,e}finishMalloc(e,t){let s=this.table[e],i=di(this.offset-s,t,0)
this.table[e+1]=i}size(){return this.offset}getaddr(e){return this.table[e]}gethandle(e){this.table.push(e,di(0,0,3))
let t=this.handle
return this.handle+=2,t}sizeof(e){return-1}scopesizeof(e){return(1073676288&this.table[e+1])>>16}free(e){let t=this.table[e+1]
this.table[e+1]=mi(t,1)}compact(){let e=0,t=this.table,s=this.table.length,i=this.heap
for(let n=0;n<s;n+=2){let s=t[n],r=t[n+1],a=65535&r,l=-1&r
if(2!==l)if(1===l)t[n+1]=mi(r,2),e+=a
...
return{handle:this.handle,table:this.table,buffer:e}}}class gi{constructor(e=new hi,t=new fi){this.constants=e,this.heap=t,this._opcode=new pi(this.heap)}opcode(e){return this._opcode.offset=e,this._opcode}}class bi extends gi{}var vi={id:"j7SGa6Pm",block:'{"symbols":["root"],"statements":[[4,"each",[[22,["roots"]]],[["key"],["id"]],{"statements":[[4,"in-element",[[21,1,["parent"]]],[["guid","nextSibling"],["%cursor:0%",[21,1,["nextSibling"]]]],{"statements":[[1,[26,"component",[[21,1,["component"]]],null],false]],"parameters":[]},null]],"parameters":[1]},null]],"hasEval":false}',meta:{specifier:"template:/-application/application/src/templates/main"}}
...
return i}(t)
throw new Error(`You tried to create an action with the {{action}} helper, but the first argument ${s}was ${typeof e} instead of a function.`)}(n,i.positional.at(0)),new zs(function(...e){let t=i.positional.value()
t.shift(),t.push(...e),n.apply(s&&s.value(),t)})}function ki(e){return e[0]?e[1]:e[2]}class wi{constructor(e){this.resolver=e}getComponentDefinition(e){let s=this.resolver.resolve(e)
...
return{compile:()=>s.handle,symbolTable:s.symbolTable}}lookupHelper(e,t){return this.resolver.lookupHelper(e,t)}lookupModifier(e,t){return this.resolver.lookupModifier(e,t)}lookupComponentDefinition(e,t){return this.resolver.lookupComponentHandle(e,t)}lookupPartial(e,t){return this.resolver.lookupPartial(e,t)}}class Si{constructor(e){this.resolver=e}async getTemplateIterator(e,t,s,n,r){let a=new ri(e),l={program:new bi(new ci(a)),macros:new Ae,resolver:new wi(a),Builder:Fe}
a.setCompileOptions(l),a.registerTemplate("main",vi),a.registerInternalHelper("action",yi),a.registerHelper("if",ki)
let o=function({id:e,meta:t,block:s}){let n,r=e||`client-${Bs++}`
return{id:r,meta:t,create:(e,a)=>{let l=a?i({},a,t):t
return n||(n=JSON.parse(s)),new Rs(e,{id:r,block:n,referrer:l})}}}(vi).create(l)
return Promise.resolve(o.renderLayout({env:t,builder:s,dynamicScope:n,self:r}))}}class _i{constructor({element:e,nextSibling:t=null}){this.cursor={element:e,nextSibling:t}}getBuilder(e){return function(e,t){return ds.forInitialRender(e,t)}(e,this.cursor)}}class Ei{render(e){let t
do{t=e.next()}while(!t.done)
this.result=t.value}rerender(){if(!this.result)throw new Error("Cannot re-render before initial render has completed")
this.result.rerender()}}function Ci(e){return void 0!==e.rootName&&void 0!==e.collection&&void 0!==e.name&&void 0!==e.type}function xi(e){let t=e.type,s=function(e){let t=[]
...
return Ci(e)&&(s="/"+s),s}}(e)
return s?t+":"+s:t}function Oi(e){let t={}
...
return t}function Ai(e,t){if(!t)throw new Error("Assertion Failed: "+e)}class Ni{constructor(e,t){this.config=e,this.registry=t}identify(e,t){if(function(e){var t=e.split(":")
let s=t[0],i=t[1]
return!!(s&&i&&0===i.indexOf("/")&&i.split("/").length>3)}(e))return e
let s,i=Oi(e)
if(t){let e=Oi(t)
if(Ci(e)){Ai("Specifier must not include a rootName, collection, or namespace when combined with an absolute referrer",void 0===i.rootName&&void 0===i.collection&&void 0===i.namespace),i.rootName=e.rootName,i.collection=e.collection
...
i.rootName=i.collection=i.namespace=void 0}else Ai('Referrer must either be "absolute" or include a `type` to determine the associated type',e.type),i.collection=this._definitiveCollection(e.type),i.namespace||(i.namespace=e.rootName),Ai(`'${e.type}' does not have a definitive collection`,i.collection)}if(i.collection||(i.collection=this._definitiveCollection(i.type),Ai(`'${i.type}' does not have a definitive collection`,i.collection)),!i.rootName){if(i.rootName=this.config.app.rootName||"app",s=this._serializeAndVerify(i))return s
...
return Ai(`'${e}' is not a recognized type`,t),t.definitiveCollection}_serializeAndVerify(e){let t=xi(e)
if(this.registry.has(t))return t}}class Ti{constructor(e={}){this._entries=e}has(e){return e in this._entries}get(e){return this._entries[e]}}var Li=function(e,t,s,i){var n,r=arguments.length,a=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,s):i
...
const Di=Symbol("register-component")
function Bi(e){return t=>{let s=Symbol("property-cache")
class i extends t{get[n=e](){if(!this[s]){let i=te(this).lookup(`service:${t=e,t.replace(/[A-Z](?:(?=[^A-Z])|[A-Z]*(?=[A-Z][^A-Z]|$))/g,function(e,t){return(t>0?"-":"")+e.toLowerCase()})}`)
i[Di]&&i[Di](()=>this[e]=i),this[s]=i}var t
return this[s]}set[e](e){this[s]=e}}return Li([V],i.prototype,n,null),i
var n}}class Ri{constructor(e){this._tracking=[],Object.assign(this,e)}static create(e){return new this(e)}[Di](e){this._tracking.push(e)}notify(){this._tracking.forEach(e=>e())}}var Mi=function(e,t,s,i){var n,r=arguments.length,a=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,s):i
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,s,i)
else for(var l=e.length-1;l>=0;l--)(n=e[l])&&(a=(r<3?n(a):r>3?n(t,s,a):n(t,s))||a)
return r>3&&a&&Object.defineProperty(t,s,a),a}
class Ii extends Ri{constructor(){super(...arguments),this.onlineCustomers=null,this.state=null,this.intervalId=null}pollUpdates(){console.log("polling"),this.intervalId=setInterval(()=>{this.state="fetching",this.notify(),this.fetch().then(e=>{this.state="success",this.onlineCustomers=e,console.log("update"),this.notify()})},2e3)}stopPolling(){console.log("stoped polling"),clearInterval(this.intervalId)}fetch(){return new Promise(e=>{var t=window.setTimeout(()=>{e(+new Date),clearTimeout(t)},2e3)})}}Mi([V],Ii.prototype,"onlineCustomers",void 0),Mi([V],Ii.prototype,"state",void 0)
class Pi extends Ri{constructor(e){super(e),this._online=(()=>{this.isOnline=!0,self.dispatchEvent(new CustomEvent("WecoOnline")),this.notify()}),this._offline=(()=>{this.isOnline=!1,self.dispatchEvent(new CustomEvent("WecoOffline")),this.notify()}),this.isOnline=null,this.isOnline=!self.navigator||self.navigator.onLine,self.addEventListener("online",this._online),self.addEventListener("offline",this._offline)}destroy(){self.removeEventListener("online",this._online),self.removeEventListener("offline",this._offline)}}(function(e,t,s,i){var n,r=arguments.length,a=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,s):i
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,s,i)
else for(var l=e.length-1;l>=0;l--)(n=e[l])&&(a=(r<3?n(a):r>3?n(t,s,a):n(t,s))||a)
r>3&&a&&Object.defineProperty(t,s,a)})([V],Pi.prototype,"isOnline",void 0)
var Fi=function(e,t,s,i){var n,r=arguments.length,a=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,s):i
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,s,i)
else for(var l=e.length-1;l>=0;l--)(n=e[l])&&(a=(r<3?n(a):r>3?n(t,s,a):n(t,s))||a)
return r>3&&a&&Object.defineProperty(t,s,a),a}
let ji=class extends K{constructor(e){super(e),this._online=(()=>{this.analytics.pollUpdates()}),this._offline=(()=>{this.analytics.stopPolling()}),this.isDisabled||this._online(),self.addEventListener("WecoOnline",this._online),self.addEventListener("WecoOnline",this._offline)}get isDisabled(){return!this.online.isOnline}get status(){return this.analytics.state}get customers(){return this.analytics.onlineCustomers}}
Fi([V("online")],ji.prototype,"isDisabled",null),Fi([V("analytics")],ji.prototype,"status",null),Fi([V("analytics")],ji.prototype,"customers",null)
var Vi=ji=Fi([Bi("online"),Bi("analytics")],ji),Hi=function(e,t,s,i){var n,r=arguments.length,a=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,s):i
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,s,i)
else for(var l=e.length-1;l>=0;l--)(n=e[l])&&(a=(r<3?n(a):r>3?n(t,s,a):n(t,s))||a)
return r>3&&a&&Object.defineProperty(t,s,a),a}
let zi=class extends K{get isDisabled(){return!this.online.isOnline}}
Hi([V("online")],zi.prototype,"isDisabled",null)
var Ui={"service:/codecamp2018/services/analytics":Ii,"service:/codecamp2018/services/online":Pi,"component:/codecamp2018/components/OnlineCustomers":Vi,"template:/codecamp2018/components/OnlineCustomers":{id:"f67oFGRh",block:'{"symbols":[],"statements":[[6,"div"],[10,"class","online-customers"],[8],[0,"\\n"],[4,"if",[[26,"eq",[[22,["status"]],"fetching"],null]],null,{"statements":[[0,"    "],[6,"div"],[10,"class","status"],[8],[0,"Updating..."],[9],[0,"\\n"]],"parameters":[]},null],[4,"if",[[26,"eq",[[22,["status"]],"success"],null]],null,{"statements":[[0,"    "],[6,"div"],[10,"class","number"],[8],[0,"Online customers: "],[1,[20,"customers"],false],[9],[0,"\\n"]],"parameters":[]},null],[9],[0,"\\n"]],"hasEval":false}',meta:{specifier:"template:/codecamp2018/components/OnlineCustomers"}},"component:/codecamp2018/components/OnlineIndicator":zi=Hi([Bi("online")],zi),"template:/codecamp2018/components/OnlineIndicator":{id:"+bEtS0Fj",block:'{"symbols":[],"statements":[[6,"div"],[11,"class",[27,["online-indicator ",[26,"inline-if",[[22,["online","isOnline"]],"is-online"],null]," ",[26,"inline-if",[[22,["isDisabled"]],"id-offline"],null]]]],[8],[0,"\\n"],[9],[0,"\\n"]],"hasEval":false}',meta:{specifier:"template:/codecamp2018/components/OnlineIndicator"}},"helper:/codecamp2018/components/eq":function([e,t]){return e===t},"helper:/codecamp2018/components/inline-if":function([e,t,s]){return e?t:s}},$i={app:{name:"codecamp2018",rootName:"codecamp2018"},types:{application:{definitiveCollection:"main"},component:{definitiveCollection:"components"},"component-test":{unresolvable:!0},helper:{definitiveCollection:"components"},"helper-test":{unresolvable:!0},renderer:{definitiveCollection:"main"},template:{definitiveCollection:"components"},service:{definitiveCollection:"services"}},collections:{main:{types:["application","renderer"]},components:{group:"ui",types:["component","component-test","template","helper","helper-test"],defaultType:"component",privateCollections:["utils"]},styles:{group:"ui",unresolvable:!0},utils:{unresolvable:!0},services:{types:["service"],defaultType:"service",privateCollections:["utils"]}}}
const Gi=new class extends si{constructor(){let e=new Ti(Ui),t=new Ni($i,e)
const s=document.body
super({builder:new _i({element:s,nextSibling:null}),loader:new Si(t),renderer:new Ei,resolver:t,rootName:$i.app.rootName})}}
Y=(()=>{Gi.scheduleRerender()}),Gi.registerInitializer({initialize(e){e.register(`component-manager:/${Gi.rootName}/component-managers/main`,Gs)}}),Gi.boot(),function(e,t){for(let s in t)Ws(e,s,t[s])}(Gi,{"online-indicator":"OnlineIndicator","online-customers":"OnlineCustomers"})})
